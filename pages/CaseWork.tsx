  ...
  const cases = [
    {
      ...
      description: "Carrier denied the claim outright, citing 'lack of causation.' Our forensic file established clean event specificity linking damage to a specific hurricane date — addressing the basis for the denial.",
    ...
    },
    {
      ...
      description: "Initial offer covered just 10% of the documented damage. StormChecks documented the complete scope of loss, which the owner's public adjuster used to support a reassessment.",
    ...
    },
    {
      ...
      description: "Carrier offered 4% of the documented damage. Forensic inspection and meteorological analysis documented the true scope of loss.",
      quote: ''
    },
    {
      title: "Retail Center",
      ...
      description: "Event-specific damage previously unrecognized by maintenance teams. Expert File documented the full scope of loss.",
      quote: ''
    },
    {
    ...
    },
    {
      ...
      description: "Our carrier-grade evidence package addressed the basis for the full denial, linking envelope breaches to specific storm pressure changes.",
      quote: ''
    },
    {
      title: "Commercial Property",
      ...
      description: "Initial inspection missed latent roof fracturing. StormChecks documentation established storm attribution.",
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
             ...
             <div className="text-center">
                ...
                <div className="text-sm text-gray-500 font-medium uppercase tracking-wide">IN DOCUMENTED LOSSES</div>
             </div>
             ...
             <div className="text-center">
                ...
                <div className="text-sm text-gray-500 font-medium uppercase tracking-wide">FREE WEATHER MONITORING</div>
             </div>
      ...
      <section className="bg-primary py-24 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-12 leading-relaxed">
            Most of these owners didn't know they had hidden storm damage until we found it. Free assessment takes 2 minutes to set up.
          </p>
